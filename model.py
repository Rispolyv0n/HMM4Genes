...
class MarkovBase(object):
    ...
    def fit(self):
        raise NotImplementedError('Function `fit` should be implemented.')
    ...
    def generating_prob(self):
        raise NotImplementedError('Function `generating_prob` should be implemented.')
